...
/**
 * TbLoopRect generated by hbm2java
 */
@Entity
@Table(name = "tb_loop_rect", catalog = "gnamp_v4")
public class TbLoopRect implements java.io.Serializable {

	private TbLoopRectId id;
	...
	private Set<TbLoopRectContent> tbLoopRectContents = new HashSet<TbLoopRectContent>(0);
	private Set<TbLoopProgram> tbLoopPrograms = new HashSet<TbLoopProgram>(0);

	public TbLoopRect() {
	}

	public TbLoopRect(TbLoopRectId id, TbLoopProgram tbLoopProgram, String name, String descp, int layer, int type,
	...
	public TbLoopRect(TbLoopRectId id, TbLoopProgram tbLoopProgram, String name, String descp, int layer, int type,
			int posX, int posY, int width, int height, String detail, Set<TbLoopRectContent> tbLoopRectContents,
			Set<TbLoopProgram> tbLoopPrograms) {
		this.id = id;
		this.tbLoopProgram = tbLoopProgram;
		this.name = name;
		this.descp = descp;
		...
		this.height = height;
		this.detail = detail;
		this.tbLoopRectContents = tbLoopRectContents;
	...
	public TbLoopRectId getId() {
		return this.id;
	}

	public void setId(TbLoopRectId id) {
		this.id = id;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "tbLoopRect")
	public Set<TbLoopRectContent> getTbLoopRectContents() {
		return this.tbLoopRectContents;
	}

	public void setTbLoopRectContents(Set<TbLoopRectContent> tbLoopRectContents) {
		this.tbLoopRectContents = tbLoopRectContents;
	}
