...
/**
 * TbFileDustbinId generated by hbm2java
 */
@Embeddable
public class TbFileDustbinId implements java.io.Serializable {

	private int cstmId;
	private long fileId;

	public TbFileDustbinId() {
	}

	public TbFileDustbinId(int cstmId, long fileId) {
		this.cstmId = cstmId;
		this.fileId = fileId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TbFileDustbinId))
			return false;
		TbFileDustbinId castOther = (TbFileDustbinId) other;
