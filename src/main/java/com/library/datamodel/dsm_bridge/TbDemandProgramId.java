...
/**
 * TbDemandProgramId generated by hbm2java
 */
@Embeddable
public class TbDemandProgramId implements java.io.Serializable {

	private int cstmId;
	private int taskId;
	private int prgmId;

	public TbDemandProgramId() {
	}

	public TbDemandProgramId(int cstmId, int taskId, int prgmId) {
		this.cstmId = cstmId;
		this.taskId = taskId;
		this.prgmId = prgmId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TbDemandProgramId))
			return false;
		TbDemandProgramId castOther = (TbDemandProgramId) other;
