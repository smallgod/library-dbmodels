...
/**
 * TbLoopRectId generated by hbm2java
 */
@Embeddable
public class TbLoopRectId implements java.io.Serializable {
	...
	public TbLoopRectId(int cstmId, int taskId, int prgmId, int rectId) {
		this.cstmId = cstmId;
		this.taskId = taskId;
		this.prgmId = prgmId;
		this.rectId = rectId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TbLoopRectId))
			return false;
		TbLoopRectId castOther = (TbLoopRectId) other;
