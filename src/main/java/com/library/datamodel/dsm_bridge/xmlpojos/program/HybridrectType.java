...
/**
 * <p>Java class for hybridrectType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="hybridrectType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "hybridrectType", propOrder = {
    "videoOrImg"
})
public class HybridrectType {

    @XmlElements({
        @XmlElement(name = "video", type = VideoType.class),
        @XmlElement(name = "img", type = ImgType.class)
    })
    protected List<Object> videoOrImg;
    ...
    /**
     * Gets the value of the videoOrImg property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the videoOrImg property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVideoOrImg().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getVideoOrImg() {
        if (videoOrImg == null) {
            videoOrImg = new ArrayList<Object>();
        }
