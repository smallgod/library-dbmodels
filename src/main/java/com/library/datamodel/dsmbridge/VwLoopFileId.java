...
/**
 * VwLoopFileId generated by hbm2java
 */
public class VwLoopFileId implements java.io.Serializable {
	...
	public VwLoopFileId(int cstmId, int taskId) {
		this.cstmId = cstmId;
		this.taskId = taskId;
	}

	public VwLoopFileId(int cstmId, int taskId, Long fileId) {
		this.cstmId = cstmId;
		this.taskId = taskId;
		this.fileId = fileId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VwLoopFileId))
			return false;
		VwLoopFileId castOther = (VwLoopFileId) other;
