...
/**
 * TbPluginProgramId generated by hbm2java
 */
public class TbPluginProgramId implements java.io.Serializable {

	private int cstmId;
	private int taskId;
	private int prgmId;

	public TbPluginProgramId() {
	}

	public TbPluginProgramId(int cstmId, int taskId, int prgmId) {
		this.cstmId = cstmId;
		this.taskId = taskId;
		this.prgmId = prgmId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TbPluginProgramId))
			return false;
		TbPluginProgramId castOther = (TbPluginProgramId) other;
